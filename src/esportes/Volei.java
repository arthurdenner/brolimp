...
public class Volei extends Esporte {
	...
	public void jogar(ConexaoBanco db) {
        ...
        db.conectar();
        equipes = db.getProximaPartida("Volei");
        try {
            ...
            db.armazenarResultadoPartida("Volei", ptsEquipe1, ptsEquipe2, numeroPartida);
            
            if(ptsEquipe1 == ptsEquipe2){
            	db.registrarPontuacao("Volei", equipe1, 1);
            	db.registrarPontuacao("Volei", equipe2, 1);
            } else if (ptsEquipe1 > ptsEquipe2){
            	db.registrarPontuacao("Volei", equipe1, 3);
            } else {
            	db.registrarPontuacao("Volei", equipe2, 3);
            }
        } catch (Exception e){
        	return;
        }
